/**
 * Date and Price Range Drawing Implementation
 * 
 * A 2-point drawing tool for measuring both vertical (price) and horizontal (time) distance.
 * Shows price difference, % change, bar count, duration, and volume.
 * 
 * Points:
...
export class DatePriceRangeDrawing implements Drawing, DrawingSettingsProvider {
    readonly id: string;
    readonly type: DrawingType = 'datePriceRange';
    ...
    static fromJSON(data: SerializedDrawing): DatePriceRangeDrawing {
        const drawing = new DatePriceRangeDrawing({
