...
export const ICONS = {
    ...
    settings: `<svg width="20" height="20" viewBox="0 0 28 28" fill="currentColor">
    ...
    clone: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
